...
Run the following from the ui-gobi-settings directory to serve your new app using a development server:
```
stripes serve
```
...
See project [UIGS](https://issues.folio.org/browse/UIGS)
